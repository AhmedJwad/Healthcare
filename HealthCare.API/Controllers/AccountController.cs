...
namespace HealthCare.API.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(DataContext context,ICombosHelper combosHelper, IuserHelper userhelper , IBlobHelper blobHelper , 
        ...
        public IActionResult Register()
        {
            ...
            {
               Usertypes =  _combosHelper.GetUserTypes(),
            };
        ...
        public async Task<IActionResult> Register(AddUserViewModel model , int id)
        {
            if(ModelState.IsValid)
            {
