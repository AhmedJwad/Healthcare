...
{
    [Authorize(Roles = "Admin , User , Patient")]
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Details(string Id)
        {
            ...
            User user = await _context.Users.Include(x=>x.Patients).ThenInclude(x=>x.userPatient).ThenInclude(x=>x.User)
                ...
                .Include(x => x.Patients).ThenInclude(p => p.userPatient)
        ...
        public async Task<IActionResult> DetailsUserPatient(string Id)
        {
            ...
            User user = await _context.Users.Include(x => x.UserPatients).ThenInclude(x => x.Patients)
                ...
                .Include(x => x.UserPatients).ThenInclude(x => x.Patients).ThenInclude(P => P.histories).FirstOrDefaultAsync(x => x.Id == Id);
